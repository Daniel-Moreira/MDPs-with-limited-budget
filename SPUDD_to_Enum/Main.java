...
{	
	...
	public static void main(String args[])
    {
		...
		Arquivo arquivoSaida = new Arquivo(args[0].substring(0, args[0].length()-3) + "net", Arquivo.ESCRITA);
